...
function createModal(e) {
    e.preventDefault();
    const contentNodeAuthorization = 'Привет';
    const contentNodeForm = 'форма редактирования';
    ...
    switch (btnValueDataTarget) {
        case 'formModal':
            modal = new Modal('formModal', 'Анкета', contentNodeForm);
            break;

        case 'authorizationModal':
            modal = new Modal('authorizationModal', 'Авторизация', contentNodeAuthorization);
            break;
    }
